...
class Message {
    ...
    public static function fromEntity(MessageEntity $messageEntity): self {
        return (new self())
            ...
            ->setVisibilities(array_map(fn(UserTypeEntity $userTypeEntity) => $userTypeEntity->getUserType()->value, $messageEntity->getVisibilities()->toArray()))
            ...
            ->setDownloadEnabledUserTypes(array_map(fn(UserTypeEntity $userTypeEntity) => $userTypeEntity->getUserType()->value, $messageEntity->getDownloadEnabledUserTypes()->toArray()))
            ...
            ->setUploadEnabledUserTypes(array_map(fn(UserTypeEntity $userTypeEntity) => $userTypeEntity->getUserType()->value, $messageEntity->getUploadEnabledUserTypes()->toArray()))
