...
use App\Common\Form\Collection\EmailCollectionEntryType;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void {
        $builder
            ...
            ->add('bookAttendanceType', ChoiceType::class, [
                'choices' => [
                    'book.attendance.type.present' => \App\Book\Entity\AttendanceType::Present,
                    'book.attendance.type.absent' => \App\Book\Entity\AttendanceType::Absent
                ],
