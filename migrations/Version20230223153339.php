 ...
 */
final class Version20230223153339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teacher_absence (id INT UNSIGNED AUTO_INCREMENT NOT NULL, teacher_id INT UNSIGNED DEFAULT NULL, processed_by_id INT UNSIGNED DEFAULT NULL, reason VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, processed_at DATETIME DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', from_date DATE NOT NULL, from_lesson INT NOT NULL, until_date DATE NOT NULL, until_lesson INT NOT NULL, INDEX IDX_BB986D8841807E1D (teacher_id), INDEX IDX_BB986D882FFD4FD3 (processed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
