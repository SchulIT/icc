...
class TeacherConverterTest extends WebTestCase {
    ...
    public function testMale() {
        ...
        $this->assertEquals('Herr Mustermann [MUSM]', $converter->convert($teacher));
    }
    ...
    public function testFemale() {
        $teacher = (new Teacher())
            ...
            ->setTitle('Dr.');
        $converter = new TeacherStringConverter($this->getTranslator());
        $this->assertEquals('Frau Dr. Musterfrau [MUSF]', $converter->convert($teacher));
    }
    ...
    public function testX() {
        $teacher = (new Teacher())
            ...
            ->setLastname('Doe');
        $converter = new TeacherStringConverter($this->getTranslator());
        $this->assertEquals('Doe [DOEX]', $converter->convert($teacher));
    }
}