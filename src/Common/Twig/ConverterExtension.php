...
use App\Common\Converter\FancyUserStringConverter;
use App\Common\Converter\GradesStringConverter;
use App\Common\Converter\StudentStringConverter;
use App\Common\Converter\StudyGroupsGradeStringConverter;
...
class ConverterExtension extends AbstractExtension {
    ...
    public function __construct(
        ...
        private readonly StudentStringConverter $studentConverter,
        private readonly UserStringConverter $userConverter,
        private readonly StudyGroupStringConverter $studyGroupConverter,
        private readonly FancyUserStringConverter $fancyUserStringConverter,
        private readonly GradesStringConverter $gradeStringConverter,
        private readonly StudyGroupsGradeStringConverter $studyGroupsConverter,
    ) {
