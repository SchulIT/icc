...
GPU;
        ...
        $substitutions = $reader->readGpu(Reader::createFromString($lines));
        ...
        $this->assertEquals(GpuSubstitutionFlag::SpecialDuty, $current->getFlags());
        ...
        $this->assertEquals(GpuSubstitutionFlag::Cancellation, $current->getFlags());
